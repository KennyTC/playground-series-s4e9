...
def generate_feature(train_file, test_file, train_feature_file,
    ...
    def ft_eng(df):       
        ...
        for col in ['has_accident', 'fuel_category', 'milage_impact1', 'milage_impact2', 'model_year_impact1', 'model_year_impact2', 'milage_impact1', 'model_year','is_title_clean']:
    ...
    # df_train, df_test = df[:n_trn], df[n_trn:]
    # df_train[TARGET_COL] = y

    # df_train.to_csv(train_feature_file)
    # df_test.to_csv(test_feature_file)

    save_data(df[:n_trn], y, train_feature_file)
    save_data(df[n_trn:], None, test_feature_file)
